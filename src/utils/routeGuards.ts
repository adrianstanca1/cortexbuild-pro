...
const PAGE_ROLES: Record<string, UserRole[]> = {
  ...
  'ACCOUNTING_HUB': [UserRole.SUPERADMIN, UserRole.COMPANY_ADMIN, UserRole.PROJECT_MANAGER, UserRole.FINANCE],
  'AI_COMMAND_CENTRE': [UserRole.SUPERADMIN, UserRole.COMPANY_ADMIN, UserRole.PROJECT_MANAGER, UserRole.FINANCE],
