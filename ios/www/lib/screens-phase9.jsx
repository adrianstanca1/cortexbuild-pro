  ...
  return (
    <ScreenBg accent={accent}>
      <div style={{ flex: 1, overflowY: 'auto', paddingBottom: 150 }}>
        <MobileHeader title="Executive" subtitle="Thu 30 Apr · Wk 17" ws
          right={<HeaderBtn icon={Ic.bell} count={(window.CortexPortalMsgs&&window.CortexPortalMsgs.unreadCount())||0} accent={accent} onClick={() => window.cortexxNav && window.cortexxNav('inbox')}/>}/>
