...
import { ToolDefinition, AI_TOOLS } from '../../../tool-definitions';
...
const AIToolsScreen: React.FC<AIToolsScreenProps> = ({ currentUser, navigateTo, goBack, openProjectSelector, onDeepLink, can }) => {
