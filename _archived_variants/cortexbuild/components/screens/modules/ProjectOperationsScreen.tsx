...
import { ToolDefinition, PROJECT_OPERATIONS_TOOLS } from '../../../tool-definitions';
...
const ProjectOperationsScreen: React.FC<ProjectOperationsScreenProps> = ({ currentUser, navigateTo, goBack, openProjectSelector, onDeepLink, can }) => {
