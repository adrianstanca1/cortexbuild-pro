...
const AnalyticsDashboard: React.FC<AnalyticsDashboardProps> = ({ isDarkMode = true }) => {
    ...
    return (
        <LazyComponentWrapper isDarkMode={isDarkMode} showSkeleton={true} skeletonHeight="h-96">
                                ...
                                {topApps.map((app, index) => (
                                    ...
                                    >
                                        <div className="flex items-center gap-4">
                                            <div className={`w-10 h-10 rounded-full flex items-center justify-center font-bold text-white ${index === 0 ? 'bg-gradient-to-br from-yellow-500 to-orange-500' :
