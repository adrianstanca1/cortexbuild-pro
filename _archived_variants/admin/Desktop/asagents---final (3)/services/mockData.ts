...
let users: User[] = [
  ...
  { id: 11, name: 'Bob Manager', email: 'bob@construction.com', role: Role.PM, companyId: 1, status: UserStatus.ON_SITE, avatarUrl: 'https://i.pravatar.cc/150?u=11' },
  ...
  { id: 14, name: 'Ethan Operative', email: 'ethan@construction.com', role: Role.OPERATIVE, companyId: 1, status: UserStatus.ON_SITE, avatarUrl: 'https://i.pravatar.cc/150?u=14' },
];
...
let todos: Todo[] = [
  ...
  { id: 1004, text: 'Source and order bespoke windows', projectId: 100, assigneeId: 11, creatorId: 10, status: TodoStatus.DONE, priority: TodoPriority.LOW, dueDate: new Date('2024-06-01'), completedAt: new Date('2024-05-30'), completedBy: 11 },
];
...
let equipment: Equipment[] = [
    { id: 1, companyId: 1, name: 'Excavator EX-250', type: 'Heavy Machinery', status: EquipmentStatus.IN_USE, projectId: 101, lastAssignedDate: new Date('2024-07-20') },
    { id: 2, companyId: 1, name: 'Tower Crane TC-01', type: 'Crane', status: EquipmentStatus.IN_USE, projectId: 100, lastAssignedDate: new Date('2024-06-15') },
    { id: 3, companyId: 1, name: 'Concrete Mixer CM-5', type: 'Machinery', status: EquipmentStatus.AVAILABLE, projectId: null },
    { id: 4, companyId: 1, name: 'Scaffolding Set A', type: 'Support', status: EquipmentStatus.MAINTENANCE, projectId: null, maintenanceStartDate: new Date('2024-07-25'), estimatedAvailableDate: new Date(new Date().setDate(new Date().getDate() + 7)) },
];
...
let auditLogs: AuditLog[] = [
    { id: 2, actorId: 10, action: "approved_timesheet", target: { type: 'Timesheet', id: 1, name: `Timesheet for Diana Operative` }, timestamp: new Date(Date.now() - 7200000) },
    { id: 1, actorId: 11, action: "completed_task", target: { type: 'Todo', id: 1004, name: "Source and order bespoke windows" }, timestamp: new Date(Date.now() - 3600000) },
    { id: 5, actorId: 11, action: "added_comment_to_task", target: { type: 'Todo', id: 1002, name: "Install HVAC system on floors 1-5" }, timestamp: new Date(Date.now() - 43200000) },
    { id: 3, actorId: 12, action: "reported_safety_incident", target: { type: 'SafetyIncident', id: 1, name: "Minor slip near scaffolding" }, timestamp: new Date(Date.now() - 86400000) },
    { id: 4, actorId: 13, action: "uploaded_document", target: { type: 'Document', id: 101, name: "Structural Plans v3.pdf" }, timestamp: new Date(Date.now() - 172800000) },
    { id: 6, actorId: 10, action: "created_project", target: { type: 'Project', id: 102, name: "Old Town Bridge Repair" }, timestamp: new Date(Date.now() - 604800000) },
];
