...
async function verifyIsolation() {
    ...
    const tenantA = await companyProvisioningService.provisionCompany({
        name: 'Tenant A Construction',
    ...
    const tenantB = await companyProvisioningService.provisionCompany({
        name: 'Tenant B Builders',
        ownerEmail: 'owner@tenantb.com',
        ownerName: 'Bob Owner'
    });
