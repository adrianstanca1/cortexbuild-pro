...
function GlobalSideMenu({ accent = T.blue }) {
  ...
  const SECTIONS = [
    { h: 'Workspace', items: [
      ...
      { l: 'My day', i: Ic.clock, k: 'myday' },
      { l: 'Tomorrow', i: Ic.calendar || Ic.clock, k: 'tomorrow' },
      { l: 'Calendar', i: Ic.calendar || Ic.book, k: 'calendar' },
      { l: 'Projects', i: Ic.projects, k: 'tab', p: 'projects' },
      { l: 'Tasks', i: Ic.tasks, k: 'tab', p: 'tasks' },
      { l: 'Goals', i: Ic.trend, k: 'goals' },
      { l: 'Activity', i: Ic.activity || Ic.list, k: 'activity' },
      { l: 'Timeline', i: Ic.list, k: 'timeline' },
    ] },
    { h: 'Site operations', items: [
      ...
      { l: 'Inspections', i: Ic.check || Ic.shield, k: 'inspections' },
      { l: 'Permits', i: Ic.doc, k: 'permits' },
      { l: 'RFIs', i: Ic.inbox, k: 'rfis' },
      { l: 'Drawings', i: Ic.layers, k: 'drawings' },
      { l: 'Photos', i: Ic.camera, k: 'photos' },
      { l: 'Photo review', i: Ic.camera, k: 'photoreview' },
      { l: 'Deliveries', i: Ic.truck, k: 'delivery' },
      { l: 'NFC site tags', i: Ic.flag, k: 'nfctags' },
      { l: 'Weekly report', i: Ic.doc, k: 'weeklyreport' },
      { l: 'Day end', i: Ic.moon || Ic.clock, k: 'dayend' },
    ] },
    { h: 'Safety & compliance', items: [
      { l: 'Safety hub', i: Ic.safety, k: 'safety' },
      { l: 'Report incident', i: Ic.alert, k: 'incident' },
      { l: 'RIDDOR', i: Ic.shield, k: 'riddor' },
      { l: 'Toolbox talks', i: Ic.hardhat, k: 'toolboxtalk' },
      { l: 'Training', i: Ic.hardhat, k: 'training' },
      { l: 'Health check', i: Ic.activity || Ic.shield, k: 'health' },
      { l: 'Audit log', i: Ic.shield, k: 'auditlog' },
    ] },
    { h: 'Sales & clients', items: [
      { l: 'Leads', i: Ic.trend, k: 'leads' },
      { l: 'Customers', i: Ic.team, k: 'customers' },
      { l: 'Quotes', i: Ic.doc, k: 'quotes' },
      { l: 'Estimator', i: Ic.edit, k: 'estimate' },
      { l: 'Client portal', i: Ic.briefcase, k: 'portal' },
      { l: 'Client messages', i: Ic.inbox, k: 'clientmsgs' },
      { l: 'Reviews', i: Ic.star || Ic.trend, k: 'reviews' },
    ] },
    { h: 'Money & accounting', items: [
      { l: 'Money hub', i: Ic.money, k: 'money' },
      { l: 'Payments', i: Ic.money, k: 'payments' },
      { l: 'Ledger', i: Ic.book, k: 'ledger' },
      { l: 'Scan receipt', i: Ic.receipt, k: 'receipt' },
      { l: 'Open banking', i: Ic.money, k: 'bank' },
      { l: 'Bank reconciliation', i: Ic.check || Ic.money, k: 'bankrec' },
      { l: 'CIS 300', i: Ic.doc, k: 'cis300' },
      { l: 'Retention', i: Ic.clock, k: 'retention' },
      { l: 'Sub invoices', i: Ic.doc, k: 'subinvoices' },
      { l: 'Billing & plan', i: Ic.receipt, k: 'subscription' },
    ] },
    { h: 'Procurement & supply', items: [
      { l: 'Purchase orders', i: Ic.receipt, k: 'pos' },
      { l: 'Materials', i: Ic.box, k: 'materials' },
      { l: 'Equipment & plant', i: Ic.truck, k: 'equipment' },
      { l: 'Price catalog', i: Ic.list, k: 'catalog' },
      { l: 'Subcontractors', i: Ic.team, k: 'subs' },
      { l: 'Sub portal', i: Ic.briefcase, k: 'subportal' },
      { l: 'Change orders', i: Ic.edit, k: 'changes' },
    ] },
    { h: 'People & time', items: [
      { l: 'Team', i: Ic.team, k: 'tab', p: 'team' },
      { l: 'Invite teammate', i: Ic.plus, k: 'inviteteam' },
      { l: 'Timesheets', i: Ic.clock, k: 'time' },
      { l: 'Live status', i: Ic.team, k: 'livestatus' },
      { l: 'Holiday', i: Ic.calendar || Ic.clock, k: 'holiday' },
      { l: 'Payroll', i: Ic.money, k: 'payroll' },
      { l: 'Mileage', i: Ic.truck, k: 'mileage' },
      { l: 'Apprentices', i: Ic.hardhat, k: 'apprentice' },
    ] },
    { h: 'Documents & data', items: [
      { l: 'Documents', i: Ic.doc, k: 'docs' },
      { l: 'Doc generator', i: Ic.spark, k: 'docgen' },
      { l: 'Templates', i: Ic.copy, k: 'templates' },
      { l: 'Template library', i: Ic.archive, k: 'templatelib' },
      { l: 'Forms', i: Ic.list, k: 'forms' },
      { l: 'Upload', i: Ic.upload, k: 'upload' },
      { l: 'Database', i: Ic.archive, k: 'database' },
      { l: 'Labels', i: Ic.flag, k: 'labels' },
      { l: 'Data export', i: Ic.upload, k: 'dataexport' },
    ] },
    { h: 'Intelligence', items: [
      ...
      { l: 'AI engine', i: Ic.bot, k: 'aiengine' },
      { l: 'Improvement', i: Ic.trend, k: 'improve' },
      { l: 'Carbon', i: Ic.leaf || Ic.trend, k: 'carbon' },
      { l: 'Waste', i: Ic.box, k: 'waste' },
    ] },
    { h: 'Settings', items: [
      { l: 'Account', i: Ic.team, k: 'account' },
      { l: 'Workspaces', i: Ic.briefcase, k: 'workspace' },
      { l: 'Settings', i: Ic.cog, k: 'settings' },
      { l: 'Notifications', i: Ic.bell || Ic.inbox, k: 'notifprefs' },
      { l: 'Reminders', i: Ic.clock, k: 'reminders' },
      { l: 'Language', i: Ic.globe || Ic.book, k: 'language' },
      { l: 'Security (E2EE)', i: Ic.shield, k: 'e2ee' },
