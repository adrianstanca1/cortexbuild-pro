...
const demoFeatures = [
  {
    ...
    description:
      "Get a bird's eye view of all your construction projects with AI-powered insights, predictive analytics, and smart alerts that help you stay ahead of issues.",
    highlights: [
  ...
  },
  {
    ...
    description:
      "Manage every aspect of your construction projects from a single interface. Track progress, milestones, budgets, and team assignments in real-time.",
    highlights: [
  ...
  },
  {
    ...
    description:
      "Full RAMS management, toolbox talks, permits to work, and safety inspections. Built specifically for UK construction regulations.",
    highlights: [
  ...
  },
  {
    ...
    description:
      "Store, organise, and share all project documents. Version control, approval workflows, and instant access from any device.",
    highlights: [
  ...
  },
  {
    ...
    description:
      "Keep your entire team aligned with real-time updates, task assignments, and communication tools designed for construction sites.",
    highlights: [
  ...
  },
  {
    ...
    description:
      "Generate comprehensive reports and analyse project performance with powerful visualisations and exportable data.",
    highlights: [
      "Daily site reports",
...
const liveEvents = [
  {
    user: "AS",
    action: "approved RAMS for Riverside Tower",
    time: "2m ago",
    color: "bg-emerald-500",
  },
  {
    user: "CE",
    action: "uploaded 3 drawings to Bridge Renewal",
    time: "5m ago",
    color: "bg-blue-500",
  },
  {
    user: "MG",
    action: "completed safety inspection Site 4",
    time: "8m ago",
    color: "bg-green-500",
  },
  {
    user: "SB",
    action: "submitted progress claim £47,200",
    time: "12m ago",
    color: "bg-purple-500",
  },
  {
    user: "OC",
    action: "logged 8h timesheet for cladding work",
    time: "15m ago",
    color: "bg-indigo-500",
  },
];
...
export default function DemoPage() {
  ...
  useEffect(() => {
    const t = setInterval(
      () => setLiveEventIdx((i) => (i + 1) % liveEvents.length),
      3000,
    );
  ...
  useEffect(() => {
    const t = setInterval(
      () => setActiveFeature((i) => (i + 1) % demoFeatures.length),
      8000,
    );
    return () => clearInterval(t);
  }, []);
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg md:text-xl text-slate-600 max-w-3xl mx-auto">
              Explore our platform in real-time. See live dashboards, AI
              predictions, and smart automation working together &mdash; no
              signup required.
            </p>
          </div>
                ...
                <div className="grid lg:grid-cols-[1fr,280px] gap-6">
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3 mb-4">
                      <div
                        className={`w-10 h-10 rounded-xl bg-gradient-to-br ${currentFeature.color} flex items-center justify-center`}
                      >
                    ...
                    <div className="bg-slate-50 rounded-xl p-4">
                      ...
                      <div className="flex items-end gap-1 h-24">
                        {Array.from({ length: 20 }, (_, i) => {
                          const h =
                            30 +
                            Math.sin(i * 0.5 + activeFeature) * 25 +
                            Math.random() * 20;
                          return (
                            <div
                    ...
                    <div className="flex items-center gap-3 bg-indigo-50 rounded-xl px-4 py-3 border border-indigo-100">
                      ...
                      <span className="text-xs text-indigo-700 font-medium">
                        <span className="font-bold">AI Insight:</span> Based on
                        current {currentFeature.title.toLowerCase()} data, 3
                        optimisation opportunities detected. Click to review.
                      </span>
                    </div>
                      ...
                      {currentFeature.highlights.map((h, i) => (
                        ...
                        >
                          <div className="flex items-center gap-2 mb-2">
                            <CheckCircle2
                              className={`h-4 w-4 ${i < 3 ? "text-emerald-500" : "text-amber-500"}`}
                            />
                  ...
                  <div className="bg-slate-50 rounded-xl p-4 border border-slate-100">
                    ...
                    <div className="space-y-3">
                      {liveEvents.map((event, i) => (
                        ...
                        >
                          <div
                            className={`w-7 h-7 rounded-full ${event.color} flex items-center justify-center text-white text-[10px] font-bold flex-shrink-0 mt-0.5`}
                          >
                            {event.user}
                          </div>
                          <div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
            {stats.map((stat, i) => (
              <div
                key={i}
                className="text-center p-4 rounded-2xl bg-white/60 backdrop-blur-sm border border-slate-100 shadow-sm hover:shadow-lg transition-shadow"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-slate-600 max-w-2xl mx-auto">
              Explore the comprehensive suite of tools designed specifically for
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {demoFeatures.map((feature, i) => {
              ...
              return (
                <div
                  key={feature.id}
                  className="bg-white rounded-2xl p-8 border border-slate-100 shadow-sm hover:shadow-xl transition-all group cursor-pointer"
                  onClick={() => {
                    setActiveFeature(i);
      ...
      <section className="py-24 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-slate-600 max-w-2xl mx-auto">
              Built by construction professionals, for construction
              professionals.
            </p>
          </div>
            ...
            {[
              {
                icon: Target,
                title: "UK-Specific",
                desc: "Built for UK regulations including CDM 2015, Building Safety Act, and HSE requirements. Uses British English and pound sterling throughout.",
                gradient: "from-green-500 to-emerald-500",
              },
              {
                icon: Smartphone,
                title: "Mobile-First",
                desc: "Access everything from site. Capture photos, log time, complete inspections, and sign documents right from your phone or tablet.",
                gradient: "from-blue-500 to-cyan-500",
              },
              {
                icon: Lock,
                title: "Enterprise Security",
                desc: "Bank-level encryption, UK data residency, role-based permissions, and comprehensive audit trails for complete peace of mind.",
              ...
              >
                <div
                  className={`w-12 h-12 bg-gradient-to-br ${item.gradient} rounded-xl flex items-center justify-center mb-6`}
                >
      ...
      <section className="py-24 bg-gradient-to-br from-indigo-600 via-purple-600 to-indigo-700 relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg md:text-xl text-indigo-100 mb-10 max-w-2xl mx-auto">
            Join hundreds of UK construction companies already using CortexBuild
            Pro to deliver projects on time and on budget.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="text-sm">
              &copy; {new Date().getFullYear()} CortexBuild Pro. Built for UK
              Construction.
            </div>
          </div>
        </div>
