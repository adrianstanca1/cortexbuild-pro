...
const benefits = [
  {
    ...
    desc: "Quick setup, no credit card required",
  },
  {
    icon: Clock,
    title: "14-Day Free Trial",
    desc: "Full access to all Pro features",
  },
  {
    icon: Award,
          ...
          <div className="space-y-10">
            ...
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10">
              <p className="text-white/90 mb-4">
                "CortexBuild has transformed how we manage our construction
                projects. The time savings alone have been incredible."
              </p>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-400">
                    Director, Morrison Construction
                  </p>
                </div>
              </div>
            </div>
