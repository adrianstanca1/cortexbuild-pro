...
export async function POST(request: NextRequest) {
  try {
    ...
    const enabled = await isServiceModuleEnabled(moduleId, environment as ServiceEnvironment);
    const entitlement = await getServiceModuleEntitlement(moduleId, environment as ServiceEnvironment);
