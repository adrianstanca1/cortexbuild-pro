...
export async function PATCH(
  ...
  try {
    ...
    if (data.craneCapacity)
      updateData.craneCapacity = parseFloat(data.craneCapacity);
    if (data.slingCapacity)
      updateData.slingCapacity = parseFloat(data.slingCapacity);
    ...
    if (data.windSpeedLimit)
      updateData.windSpeedLimit = parseFloat(data.windSpeedLimit);
    if (data.actualWindSpeed)
      updateData.actualWindSpeed = parseFloat(data.actualWindSpeed);
