...
const DEFAULT_TEMPLATES = [
  {
    ...
    phases: [
      ...
      },
      {
        ...
        duration: 45,
        tasks: ["Drywall", "Flooring", "Ceiling", "Painting"],
      },
      {
        name: "Closeout",
        duration: 30,
        tasks: ["Punch List", "Final Inspections", "Commissioning", "Handover"],
      },
    ],
  },
  {
    ...
    phases: [
      ...
      },
      {
        name: "Foundation",
        duration: 28,
        tasks: ["Excavation", "Footings", "Foundation Walls", "Backfill"],
      },
      {
        name: "Framing",
        duration: 35,
      ...
      },
      {
        name: "Rough-Ins",
        duration: 28,
        tasks: ["Electrical", "Plumbing", "HVAC", "Insulation"],
      },
      {
        name: "Exterior",
        duration: 21,
        tasks: ["Siding", "Roofing", "Windows", "Doors"],
      },
      {
        name: "Interior Finishes",
        duration: 35,
        tasks: ["Drywall", "Trim", "Cabinets", "Flooring"],
      },
      {
        name: "Final",
        duration: 14,
        tasks: ["Paint", "Fixtures", "Landscaping", "Final Inspection"],
      },
    ],
  },
  {
    ...
    phases: [
      ...
      },
      {
        name: "Site Work",
        duration: 45,
        tasks: ["Clearing", "Earthwork", "Drainage", "Utility Relocation"],
      },
      {
        name: "Subgrade",
        duration: 30,
        tasks: ["Grading", "Compaction", "Subbase Installation", "Testing"],
      },
      {
        name: "Paving/Structure",
        duration: 60,
        tasks: ["Base Course", "Surface Course", "Curbs", "Markings"],
      },
      {
        name: "Finishing",
        duration: 30,
        tasks: ["Signage", "Barriers", "Landscaping", "Final Inspection"],
      },
    ],
  },
  {
    ...
    phases: [
      ...
      },
      {
        name: "MEP Upgrade",
        duration: 35,
        tasks: ["Electrical Upgrade", "Plumbing", "HVAC", "Fire Protection"],
      },
      {
        name: "Finishes",
        duration: 28,
        tasks: ["Walls", "Ceilings", "Flooring", "Fixtures"],
      },
      {
        name: "Closeout",
        duration: 14,
        tasks: ["Punch List", "Testing", "Documentation", "Handover"],
      },
    ],
  },
];
  ...
  try {
    ...
    for (const phase of template.phases) {
      for (const taskName of phase.tasks) {
        ...
        taskEndDate.setDate(
          taskEndDate.getDate() +
            Math.ceil(phase.duration / phase.tasks.length),
        );
