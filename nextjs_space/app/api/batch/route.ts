      ...
      case "batch_tasks": {
        ...
        if (operation === "create") {
          ...
          broadcastToOrganization(user.organizationId, {
            ...
            payload: {
              count: processed,
              message: `${processed} tasks created`,
            },
          });
          ...
          broadcastToOrganization(user.organizationId, {
            ...
            payload: {
              count: processed,
              message: `${processed} tasks updated`,
            },
          });
          ...
          broadcastToOrganization(user.organizationId, {
            ...
            payload: {
              count: processed,
              message: `${processed} tasks deleted`,
            },
          });
        }
          ...
          case "tasks":
            ...
            broadcastToOrganization(user.organizationId, {
              ...
              payload: {
                count: updated,
                status,
                message: `${updated} tasks updated to ${status}`,
              },
            });
            break;
          case "rfis":
            const rfiResult = await prisma.rFI.updateMany({
              where: { id: { in: ids } },
              data: {
                status: status as "DRAFT" | "OPEN" | "ANSWERED" | "CLOSED",
              },
            });
      ...
      case "batch_assign": {
        ...
        if (entityType === "tasks") {
          ...
          broadcastToOrganization(user.organizationId, {
            ...
            payload: {
              count: updated,
              message: `${updated} punch list items reassigned`,
            },
          });
        }
