      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        ...
        <TabsContent value="overview" className="space-y-6 mt-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            >
              <Card
                className="border-l-4 border-l-emerald-500 !bg-white"
                ...
                >
                  ...
                  <div className="mt-3 flex items-center gap-2 text-sm">
                    <span className="text-emerald-600">
                      {companyStats?.overview.completedProjects || 0} completed
                    </span>
                    <span style={{ color: "#6b7280" }}>•</span>
                    <span style={{ color: "#4b5563" }}>
                      {companyStats?.overview.totalProjects || 0} total
                    </span>
                  </div>
                </CardContent>
              </Card>
                ...
                >
                  ...
                  <div className="mt-3 flex items-center gap-2 text-sm">
                    <span style={{ color: "#059669", fontWeight: 500 }}>
                      {companyStats?.overview.completedTasks || 0} done
                    </span>
                    <span style={{ color: "#6b7280" }}>•</span>
            ...
            >
              <Card
                className="border-l-4 border-l-amber-500 !bg-white"
                style={{ backgroundColor: "#ffffff" }}
              >
                <CardContent
                  className="p-5 !bg-white"
              ...
              <Link href="/rfis">
                ...
                >
                  ...
                  <p
                    ...
                    style={{ color: "#111827" }}
                  >
                    {companyStats?.modules.rfis.total || 0}
                  </p>
              ...
              <Link href="/submittals">
                ...
                >
                  ...
                  <p
                    ...
                    style={{ color: "#111827" }}
                  >
                    {companyStats?.modules.submittals.total || 0}
                  </p>
                  <p className="text-xs" style={{ color: "#6b7280" }}>
                    Submittals
                  </p>
              ...
              <Link href="/change-orders">
                ...
                >
                  ...
                  <p
                    ...
                    style={{ color: "#111827" }}
                  >
                    {companyStats?.modules.changeOrders.total || 0}
                  </p>
                  <p className="text-xs" style={{ color: "#6b7280" }}>
                    Change Orders
                  </p>
              ...
              <Link href="/safety">
                ...
                >
                  ...
                  <p
                    ...
                    style={{ color: "#111827" }}
                  >
                    {companyStats?.modules.safety.total || 0}
                  </p>
                  <p className="text-xs" style={{ color: "#6b7280" }}>
                    Safety Incidents
                  </p>
              ...
              <Link href="/documents">
                ...
                >
                  ...
                  <p
                    ...
                    style={{ color: "#111827" }}
                  >
                    {companyStats?.modules.documents.total || 0}
                  </p>
                  <p className="text-xs" style={{ color: "#6b7280" }}>
                    Documents
                  </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card className="!bg-white" style={{ backgroundColor: "#ffffff" }}>
              <CardHeader
                className="flex flex-row items-center justify-between pb-3 !bg-white"
                style={{ backgroundColor: "#ffffff" }}
              >
                <CardTitle
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-xs" style={{ color: "#6b7280" }}>
                              {member.jobTitle || member.user.role}
                            </p>
                          </div>
                        </div>
              ...
              <CardContent>
                <div className="space-y-3">
                  {(companyStats?.topProjects || projects).length === 0 ? (
                    ...
                    (companyStats?.topProjects || projects)
                      .slice(0, 5)
                      .map((project: any) => (
                        <Link
                          key={project.id}
                            ...
                            <div>
                              ...
                              <p className="text-xs text-gray-500">
                                {project.taskCount ||
                                  ...
                                  0}{" "}
                                tasks • {project.teamSize || 0} members
                                {project.budget &&
                      ...
                      <div className="h-2 bg-gray-100 rounded-full overflow-hidden">
                        <div
                          ...
                          style={{
                            ...
                            backgroundColor:
                              taskStatusColors[item.status] || "#64748b",
                          }}
                        />
                      </div>
                    </div>
                  ))}
                  {(!companyStats?.charts.tasksByStatus ||
                    companyStats.charts.tasksByStatus.length === 0) && (
                    <p className="text-gray-500 text-sm text-center py-4">
                      No tasks data
                    </p>
                  )}
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                        ...
                        <div
                          ...
                          style={{
                            ...
                            backgroundColor: statusColors[
                              ...
                              ? "#10b981"
                              : statusColors[item.status]?.includes("amber")
                                ? "#f59e0b"
                                : statusColors[item.status]?.includes("blue")
                                  ? "#3b82f6"
                                  : statusColors[item.status]?.includes(
                                        "purple",
                                      )
                                    ? "#8b5cf6"
                                    : "#64748b",
                  ...
                  {(!companyStats?.charts.projectsByStatus ||
                    companyStats.charts.projectsByStatus.length === 0) && (
                    <p className="text-gray-500 text-sm text-center py-4">
                      No projects data
                    </p>
                  )}
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-3">
                  ...
                  {(!companyStats?.charts.membersByRole ||
                    companyStats.charts.membersByRole.length === 0) && (
                    <p className="text-gray-500 text-sm text-center py-4">
                      No team data
                    </p>
                  )}
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-2">
                  {companyStats?.activity.weeklyTrend
                    .slice(-7)
                    .map((day, i) => (
                  ...
                  {(!companyStats?.activity.weeklyTrend ||
                    companyStats.activity.weeklyTrend.length === 0) && (
                    <p className="text-gray-500 text-sm text-center py-4">
                      No activity data
                    </p>
                  )}
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between pb-3">
              ...
              <Badge variant="outline">
                {companyStats?.activity.recentCount || 0} this week
              </Badge>
            </CardHeader>
            <CardContent>
