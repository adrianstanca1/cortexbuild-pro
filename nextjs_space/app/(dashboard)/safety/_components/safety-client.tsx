...
export function SafetyClient({
  ...
  const [incidents, setIncidents] =
    useState<SafetyIncident[]>(initialIncidents);
  ...
  const fetchPhotos = async (incidentId: string) => {
    try {
      ...
      console.error("Failed to fetch photos:", _error);
    }
  };
  ...
  const handlePhotoUpload = async (file: Photo) => {
    ...
    try {
      ...
      console.error("Failed to save photo:", _error);
    }
  };
  ...
  const handlePhotoDelete = async (file: Photo) => {
    ...
    try {
      await fetch(
        `/api/safety/${selectedIncident.id}/photos?photoId=${file.id}`,
        {
          method: "DELETE",
        },
      );
    } catch (_error) {
      console.error("Failed to delete photo:", _error);
    }
  };
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <Button
          ...
          className="bg-gradient-to-r from-red-600 to-rose-600 hover:from-red-700 hover:to-rose-700 shadow-lg shadow-red-500/25"
        >
        ...
        <Card className="border-0 shadow-md">
          <CardContent className="py-16 text-center">
            ...
            <p className="text-slate-500 dark:text-slate-400 mb-4">
              Great job! No incidents match your filters
            </p>
          </CardContent>
        </Card>
      ) : viewMode === "list" ? (
                ...
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1">
                    <div className="flex flex-wrap items-center gap-2 mb-2">
                      <Badge
                        className={`${severityConfig[incident.severity].bgColor} ${severityConfig[incident.severity].color} border-0`}
                      >
                      ...
                      <Badge
                        className={`${statusConfig[incident.status].bgColor} ${statusConfig[incident.status].color} border-0`}
                      >
          ...
          <div className="space-y-4 mt-4">
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <Select
                  ...
                  onValueChange={(v) =>
                    setNewIncident({ ...newIncident, projectId: v })
                  }
                >
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(v) =>
                    setNewIncident({
                      ...newIncident,
                      severity: v as IncidentSeverity,
                    })
                  }
                >
                  <SelectTrigger className="mt-1.5">
              ...
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  ...
                  onChange={(e) =>
                    setNewIncident({
                      ...newIncident,
                      injuryOccurred: e.target.checked,
                    })
                  }
            ...
            <div>
              ...
              <Select
                ...
                onValueChange={(v) =>
                  setNewIncident({ ...newIncident, assignedToId: v })
                }
              >
                <SelectTrigger className="mt-1.5">
            ...
            <>
              ...
              <div className="space-y-5 mt-4">
                <div className="flex flex-wrap items-center gap-2">
                  <Badge
                    className={`${severityConfig[selectedIncident.severity].bgColor} ${severityConfig[selectedIncident.severity].color} border-0`}
                  >
                  ...
                  <Badge
                    className={`${statusConfig[selectedIncident.status].bgColor} ${statusConfig[selectedIncident.status].color} border-0`}
                  >
                ...
                <div className="p-4 bg-slate-50 dark:bg-slate-800 rounded-lg">
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="font-medium text-slate-900 dark:text-white">
                        {format(
                          new Date(selectedIncident.incidentDate),
                          "MMM d, yyyy h:mm a",
                        )}
                      </span>
                    </div>
                  ...
                  <div className="border-t pt-5 space-y-4">
                    ...
                    <div>
                      ...
                      <Select
                        ...
                        onValueChange={(v) =>
                          setUpdateData({ ...updateData, status: v })
                        }
                      >
                        <SelectTrigger className="mt-1.5">
                          <SelectValue />
