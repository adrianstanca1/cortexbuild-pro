...
export function SiteDiaryClient({
  diaries: initialDiaries,
  projects,
}: SiteDiaryClientProps) {
  ...
  const filteredDiaries = diaries.filter((diary) => {
    const matchesSearch =
      diary.project?.name?.toLowerCase().includes(search.toLowerCase()) ||
      diary.workProgress?.toLowerCase().includes(search.toLowerCase());
    const matchesProject =
      projectFilter === "all" || diary.projectId === projectFilter;
  ...
  const stats = {
    ...
    avgLabour:
      diaries.length > 0
        ? Math.round(
            diaries.reduce((sum, d) => sum + (d.labourCount || 0), 0) /
              diaries.length,
          )
        : 0,
  };
                  ...
                  <div className="flex-1">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                      ...
                      <div className="flex items-center gap-2 text-sm">
                        ...
                        {diary.tempAfternoon && (
                          <span>({diary.tempAfternoon}°C)</span>
                        )}
                      </div>
                      <div className="flex items-center gap-2 text-sm">
                    ...
                    {diary.delays && (
                      <div className="flex items-start gap-2 p-2 bg-orange-50 dark:bg-orange-900/20 rounded-lg">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-orange-600 dark:text-orange-300 line-clamp-1">
                            {diary.delays}
                          </p>
                        </div>
                      </div>
          ...
          <div className="grid gap-4 py-4">
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <Select
                  value={newDiary.projectId}
                  onValueChange={(v) =>
                    setNewDiary({ ...newDiary, projectId: v })
                  }
                >
                  <SelectTrigger>
            ...
            <div className="border-t pt-4">
              ...
              <div className="grid grid-cols-4 gap-4">
                <div>
                  ...
                  <Select
                    value={newDiary.weatherMorning}
                    onValueChange={(v) =>
                      setNewDiary({ ...newDiary, weatherMorning: v })
                    }
                  >
                    <SelectTrigger>
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setNewDiary({ ...newDiary, tempMorning: e.target.value })
                    }
                    placeholder="e.g., 18"
                  />
                </div>
                <div>
                  ...
                  <Select
                    value={newDiary.weatherAfternoon}
                    onValueChange={(v) =>
                      setNewDiary({ ...newDiary, weatherAfternoon: v })
                    }
                  >
                    <SelectTrigger>
                      <SelectValue placeholder="Select" />
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setNewDiary({ ...newDiary, workAreas: e.target.value })
                    }
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    onChange={(e) =>
                      setNewDiary({ ...newDiary, workProgress: e.target.value })
                    }
              ...
              <div className="grid grid-cols-3 gap-4">
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setNewDiary({ ...newDiary, labourCount: e.target.value })
                    }
                    placeholder="0"
                  />
                </div>
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setNewDiary({
                        ...newDiary,
                        equipmentOnSite: e.target.value,
                      })
                    }
            ...
            <div className="border-t pt-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <Textarea
                    ...
                    onChange={(e) =>
                      setNewDiary({ ...newDiary, delays: e.target.value })
                    }
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    onChange={(e) =>
                      setNewDiary({ ...newDiary, healthSafety: e.target.value })
                    }
              ...
              <div className="mt-3">
                ...
                <Textarea
                  ...
                  onChange={(e) =>
                    setNewDiary({ ...newDiary, generalNotes: e.target.value })
                  }
