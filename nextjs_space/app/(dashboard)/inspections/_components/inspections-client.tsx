...
export function InspectionsClient({
  ...
  const stats = {
    ...
    failed: inspections.filter(
      (i) => i.status === "FAILED" || i.status === "REQUIRES_REINSPECTION",
    ).length,
  };
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <Badge
                            className={statusConfig[inspection.status].color}
                          >
                        ...
                        {inspection.status === "IN_PROGRESS" && (
                          <>
                            <Button
                              ...
                              variant="default"
                              onClick={() =>
                                handleStatusUpdate(inspection.id, "PASSED")
                              }
                            >
                              Pass
                            </Button>
                            <Button
                              ...
                              variant="destructive"
                              onClick={() =>
                                handleStatusUpdate(inspection.id, "FAILED")
                              }
                            >
                              Fail
                            </Button>
          ...
          <div className="space-y-4">
            <div>
              ...
              <Select
                ...
                onValueChange={(v) =>
                  setNewInspection({ ...newInspection, projectId: v })
                }
              >
                <SelectTrigger>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(v) =>
                    setNewInspection({ ...newInspection, inspectionType: v })
                  }
                >
                  <SelectTrigger>
