...
export function ProjectsClient({ projects }: ProjectsClientProps) {
  ...
  const projectsWithHealth = useMemo(() => {
    return (projects ?? []).map((project: any) => {
      ...
      return { ...project, healthScore, healthLevel, taskCompletion, totalTasks, completedTasks };
    });
  }, [projects]);
  ...
  return (
    <div className="space-y-8 pb-8">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        <div>
          <h1 className="text-2xl lg:text-3xl font-bold text-slate-900 dark:text-white">Projects</h1>
          <p className="text-slate-500 dark:text-slate-400 mt-1">Manage all your construction projects in one place</p>
        </div>
        ...
        <div className="relative overflow-hidden rounded-2xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 p-6 transition-all hover:shadow-lg hover:-translate-y-0.5">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-slate-900 dark:text-white mt-1">{portfolioKPIs.active}</p>
        ...
        <div className="relative overflow-hidden rounded-2xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 p-6 transition-all hover:shadow-lg hover:-translate-y-0.5">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-slate-900 dark:text-white mt-1">{portfolioKPIs.avgCompletion}%</p>
              <p className="text-xs text-slate-400 dark:text-slate-500 mt-2">Across all active projects</p>
            </div>
        ...
        <div className="relative overflow-hidden rounded-2xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 p-6 transition-all hover:shadow-lg hover:-translate-y-0.5">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className={`text-3xl font-bold mt-1 ${portfolioKPIs.atRiskProjects > 0 ? 'text-red-600' : 'text-slate-900 dark:text-white'}`}>
        ...
        <div className="relative overflow-hidden rounded-2xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 p-6 transition-all hover:shadow-lg hover:-translate-y-0.5">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-slate-400 dark:text-slate-500 mt-2">Portfolio value</p>
            </div>
                ...
                <div className="p-6">
                  ...
                  <div className="mb-4">
                    <div className="flex items-center justify-between text-sm mb-2">
                      ...
                      <span className="font-medium text-slate-900 dark:text-white">{project?.taskCompletion || 0}%</span>
                    </div>
                  ...
                  <div className="grid grid-cols-3 gap-4 pt-4 border-t border-slate-100 dark:border-slate-700">
                    <div className="text-center">
                      ...
                      <p className="font-semibold text-slate-900 dark:text-white">{project?.totalTasks || 0}</p>
                    </div>
                    <div className="text-center">
                      <div className="flex items-center justify-center gap-1 text-slate-400 mb-1">
                      ...
                      <p className="font-semibold text-slate-900 dark:text-white">{project?._count?.teamMembers || 0}</p>
                    </div>
                    <div className="text-center">
                      <div className="flex items-center justify-center gap-1 text-slate-400 mb-1">
              ...
              <Link key={project?.id ?? index} href={`/projects/${project?.id ?? ""}`}>
                <div className="p-4 hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors cursor-pointer flex items-center gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-sm text-slate-500 dark:text-slate-400 truncate">{project?.clientName || project?.location}</p>
                  </div>
                  <div className="hidden md:flex items-center gap-6">
                    <div className="text-center">
                      <p className="text-xs text-slate-400">Tasks</p>
                      <p className="font-medium text-slate-900 dark:text-white">{project?.totalTasks || 0}</p>
                    </div>
                    <div className="text-center">
