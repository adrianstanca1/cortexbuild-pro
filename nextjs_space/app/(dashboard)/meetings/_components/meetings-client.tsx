...
export function MeetingsClient({ meetings, projects }: MeetingsClientProps) {
  ...
  const stats = {
    ...
    thisWeek: meetings.filter((m) => isThisWeek(new Date(m.meetingDate)))
      .length,
    upcoming: meetings.filter((m) => !isPast(new Date(m.meetingDate))).length,
    totalActionItems: meetings.reduce(
  ...
  const upcomingMeetings = filteredMeetings.filter(
    (m) => !isPast(new Date(m.meetingDate)),
  );
  const pastMeetings = filteredMeetings.filter((m) =>
    isPast(new Date(m.meetingDate)),
  );
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500 dark:text-slate-400 mt-1">
            Record and track project meetings
          </p>
        </div>
        <Button
                          ...
                          <div className="flex gap-4">
                            ...
                            <div className="flex-1">
                              <div className="flex flex-wrap items-center gap-2 mb-2">
                                <Badge
                                  className={`${typeConfig.bg} ${typeConfig.text} border-0`}
                                >
                                  <span className="mr-1">
                                    {typeConfig.icon}
                                  </span>
                          ...
                          <div className="flex items-center gap-4">
                            ...
                            <div>
                              <div className="flex flex-wrap items-center gap-2 mb-1">
                                <Badge
                                  className={`${typeConfig.bg} ${typeConfig.text} border-0 text-xs`}
                                >
                                  {typeConfig.label}
                                </Badge>
                              </div>
          ...
          <div className="space-y-4 mt-4">
            <div>
              ...
              <Select
                ...
                onValueChange={(v) =>
                  setNewMeeting({ ...newMeeting, projectId: v })
                }
              >
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(v) =>
                    setNewMeeting({ ...newMeeting, meetingType: v })
                  }
                >
                  <SelectTrigger className="h-11">
                    <SelectValue />
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  setNewMeeting({ ...newMeeting, meetingDate: e.target.value })
                }
                className="h-11"
              />
            </div>
