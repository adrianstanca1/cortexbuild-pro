  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'gradient-mesh': 'radial-gradient(at 40% 20%, hsla(212, 93%, 49%, 0.3) 0px, transparent 50%), radial-gradient(at 80% 0%, hsla(189, 100%, 56%, 0.2) 0px, transparent 50%), radial-gradient(at 0% 50%, hsla(221, 83%, 53%, 0.2) 0px, transparent 50%)',
        'hero-gradient': 'linear-gradient(135deg, #0ea5e9 0%, #2563eb 50%, #1e40af 100%)',
      ...
      boxShadow: {
        ...
        'elevated': '0 4px 6px -1px rgba(0, 0, 0, 0.05), 0 10px 20px -5px rgba(0, 0, 0, 0.08), 0 20px 40px -10px rgba(0, 0, 0, 0.04)',
