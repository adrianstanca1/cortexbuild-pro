...
async function main() {
  ...
  const _internalApi = await prisma.apiConnection.upsert({
    where: {
  ...
  const _weatherApi = await prisma.apiConnection.upsert({
    where: {
      serviceName_environment: {
  ...
  const _dbConnection = await prisma.apiConnection.upsert({
    where: {
      serviceName_environment: {
  ...
  const _authService = await prisma.apiConnection.upsert({
    where: {
      serviceName_environment: {
  ...
  const _realtimeService = await prisma.apiConnection.upsert({
    where: {
      serviceName_environment: {
        serviceName: 'sse',
        environment: 'PRODUCTION'
  ...
  const _emailService = await prisma.apiConnection.upsert({
    where: {
      serviceName_environment: {
