...
const navigationFolders = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        href: "/forecasting/weather-impact",
  ...
  },
  {
    ...
    items: [
      ...
      {
        href: "/safety/predictive-dashboard",
...
export function DashboardSidebar({ userRole }: DashboardSidebarProps) {
  ...
  useEffect(() => {
    ...
    navigationFolders.forEach((folder) => {
      const hasActiveItem = folder.items.some(
        (item) =>
  ...
  const isFolderActive = useCallback(
    (folder: (typeof navigationFolders)[0]) => {
        ...
        {!collapsed && (
          <div className="px-4 py-3 border-b border-slate-100 dark:border-slate-800/50">
            <div className="flex items-center gap-2 px-3 py-2 bg-gradient-to-r from-emerald-50 to-teal-50 dark:from-emerald-900/20 dark:to-teal-900/20 rounded-xl border border-emerald-200/50 dark:border-emerald-800/50">
              ...
              <div className="ml-auto text-[10px] text-emerald-600 dark:text-emerald-500 font-mono">
                v2.0
              </div>
            </div>
          </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-2">
                    ...
                    <Badge
                      variant="outline"
                      className="text-[8px] px-1.5 py-0 h-3.5 border-0 bg-gradient-to-r from-violet-500/10 to-purple-500/10 text-violet-600 dark:text-violet-400 font-bold"
                    >
                      SOON
                    </Badge>
                  </div>
