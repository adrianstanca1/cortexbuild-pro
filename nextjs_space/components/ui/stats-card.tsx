...
export function CompactStat({
  ...
  return (
    <div className={cn("flex items-center gap-2 px-3 py-2 rounded-lg", variantClasses[variant])}>
...
export function StatsGrid({ children, columns = 4 }: { children: ReactNode; columns?: 2 | 3 | 4 }) {
  const colClasses = {
