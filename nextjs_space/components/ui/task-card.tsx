        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center justify-between pt-2 border-t">
            ...
            <div className="flex items-center gap-3">
              ...
              {task.dueDate && (
                <div
                  className={`flex items-center gap-1 text-xs ${isOverdue ? "text-red-600" : "text-gray-600"}`}
                >
                  {isOverdue ? (
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              {onStatusChange ? (
                ...
                <Badge className={`mt-1 ${statusColors[task.status]}`}>
            ...
            <div>
              ...
              <Badge
                className={`mt-1 block w-fit ${priorityColors[task.priority]}`}
              >
                {task.priority}
              </Badge>
            </div>
